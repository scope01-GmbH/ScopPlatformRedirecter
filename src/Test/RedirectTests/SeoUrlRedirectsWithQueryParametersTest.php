...
class SeoUrlRedirectsWithQueryParametersTest extends RedirectTestCase
{
    ...
    protected function getDatabaseRedirects(): array
    {
        ...
        foreach ($this->seoUrls as $seoUrl){
            array_push($array, [$seoUrl[1] . "?wothiawotöihawothwoth", "https://scope01.com", 302, true]);
        }
    ...
    public function testSeoUrlRedirectsWithQueryParameters(){
        foreach ($this->seoUrls as $seoUrl){
            $this->checkRedirect($seoUrl[1]. "?wothiawotöihawothwoth", ["https://scope01.com"], 302);
        }
    }
}
